...
public interface ISoldat {
	...
	static enum TypesH {
		HUMAIN (40,3,10,2), NAIN (80,1,20,0), ELF (70,5,10,6),
		HOBBIT (20,3,5,2);
		private final int POINTS_DE_VIE, PORTEE_VISUELLE,
		PUISSANCE, TIR;
	...
	static enum TypesM {
		MONSTREUN (40,3,10,2), MONSTREDEUX (80,1,20,0), MONSTRETROIS (70,5,10,6),
		MONSTREQUATRE (20,3,5,2);
		private final int POINTS_DE_VIE, PORTEE_VISUELLE,
		PUISSANCE, TIR;
		...
		public int getPuissance() { return PUISSANCE; }
		public int getTir() { return TIR; }
		public static TypesM getTypeHAlea() {
			return values()[(int)(Math.random()*values().length)];
		}
